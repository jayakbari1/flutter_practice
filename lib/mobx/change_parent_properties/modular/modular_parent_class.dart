...
class ModularParentClass extends StatelessWidget {
  final int index;
  const ModularParentClass({Key? key, required this.index}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final readStore = Modular.get<ParentClassStore>();
